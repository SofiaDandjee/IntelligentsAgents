...
//    HashMap<Task, Integer> time;
    ...
    StateSingleTask(HashMap<Vehicle, Task> ntv, HashMap<Task, Task> ntt, HashMap<Task, Integer> t, HashMap<Task, Vehicle> v) {
        nextTaskTask = ntt;
        nextTaskVehicle = ntv;
//        time = t;
        vehicle = v;
    ...
    StateSingleTask(StateSingleTask s) {
